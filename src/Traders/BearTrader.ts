...
// New trader settings
import * as baseJson from "../../Traders/db/BearTraderBase.json";
...
export class BearTrader implements IPreAkiLoadMod, IPostDBLoadMod
{
    ...
    public preAkiLoad(container: DependencyContainer): void
    {
        ...
        this.traderHeper.registerProfileImage(baseJson, this.mod, preAkiModLoader, imageRouter, "bear.jpg");
    ...
    public postDBLoad(container: DependencyContainer): void
    {
        ...
        this.traderHeper.addTraderToLocales(baseJson, tables, baseJson.name, "Bear Trader", baseJson.nickname, baseJson.location, "");
